...
# Data 1: Most popular coffe or beverage
...
-   State when and how it was originally collected (by the original data curator, not necessarily how you found the data).
    ...
    The original data was collected through a comprehensive survey conducted by a coffee industry research group.
...
-   Identify the types of variables in your research question.
    ...
    Main Question: What are the most popular platforms for streaming movies and TV shows, as indicated by IMDb ratings and viewer preferences?

This study aims to investigate the most popular platforms for streaming movies and TV shows, as indicated by IMDb ratings and viewer preferences.
The focus is on understanding which platforms are preferred by viewers for different types of content and how these preferences are reflected in the ratings.
 ...
 - Hypothesis 2: The popularity of streaming platforms varies by genre, with certain platforms being preferred for specific types of content.
...
Variables:
 ...
 - Categorical: Title type (e.g., movie, TV series), streaming platform, genre 
 - Quantitative: Average rating, number of votes
