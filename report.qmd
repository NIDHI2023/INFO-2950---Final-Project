...
Thus, if there were really no relationship between roast level preference and the age group of a person in America, our approximation of the probability that we would see a statistic as or more extreme than 15.98422 is approximately 0. 

Difference in at least one of the age groups
null would be mu 1 = mu 2 = mu3


```{r}
text_cols <- coffee_clean_factors |>
  select(best_described_before, `coffee_a_-_notes`, `coffee_b_-_notes`, `coffee_c_-_notes`, `coffee_d_-_notes`, other_reason_for_drinking_coffee)
```
