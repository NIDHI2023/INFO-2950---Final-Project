...
Yes,the great America Coffee taste seprated entries into sub-populations at the discretion of the participant
...
*Research Question 1*
To answer the question how does coffee preference and consumption habits differ by demographic
attributes? We will look into several factors such as age, gender, education level, race, and political identity. To do this we cleaned the data in a manner that preserves variables related to coffee preference, consumption habits and demographic indicators. 
...
>>>>>>> 3e062834f20778747fef42d0d4a52f5a7481895b

In our analysis we can infer several things according to different variables and fields of participants.

Coffee Roast Level by age variable: our data and visualization suggests that age ranges 18-24 have are not only the highest percentage but also favorite Light roast and Nordic roast. And across all ages those 55 - 64 years old were the most responsive to French.

Cups of Coffee per day by Gender: The visuals suggests that people that identify as females are the highest counts of coffee drinkers per day.In all counts they drink less than 1 and more than 4.
...
Caffine prefrence per education level:In this visual we can atest to the individuals with bachelors degrees have full caffeine in thier coffee are the most commen entry. but they are also the most in terms of decaf. A more insightful observation suggests that educational levels are not a pure indicator of the levels of caffination in participants coffees.
...
The hypothesis testing resulted in a p-value of 0.35, which is larger than 0.05. This high p-value indicates that we do not have sufficient evidence to reject the null hypothesis. Therefore, we conclude that the observed difference in the variety of sweeteners used by individuals with and without a Bachelor's degree is not statistically significant.
